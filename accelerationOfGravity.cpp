...
for a given distance from the earth's center, distCenter, assigning the result to accelGravity.
...
and d is the distance in meters from the earth's center (stored in variable distCenter).
